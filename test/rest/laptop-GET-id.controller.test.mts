...
describe('GET /rest/:id', () => {
    ...
    test.concurrent('Laptop zu vorhandener ID', async () => {
        ...
        // when
        const { status, headers, data }: AxiosResponse<Laptop> =
    ...
    test.concurrent('Kein Laptop zu nicht-vorhandener ID', async () => {
        // given
    ...
    test.concurrent('Kein Laptop zu falscher ID', async () => {
        // given
        const url = `/${idFalsch}`;
    ...
    test.concurrent('Laptop zu vorhandener ID mit ETag', async () => {
        // given
