...
describe('DELETE /rest', () => {
    ...
    test.concurrent('Vorhandenes Laptop loeschen', async () => {
        // given
        const url = `/${id}`;
    ...
    test.concurrent('Laptop loeschen, aber ohne Token', async () => {
        // given
        const url = `/${id}`;
    ...
    test.concurrent('Laptop loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
    ...
    test.concurrent('Vorhandenes Laptop als "user" loeschen', async () => {
        // given
        const url = `/60`;
        const headers: Record<string, string> = {
