...
-- (7) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-laptop.sql
--        psql --dbname=laptop --username=laptop --file=/sql/create-schema-laptop.sql
--        exit
...
CREATE ROLE laptop LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE laptop;

GRANT ALL ON DATABASE laptop TO laptop;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE laptopspace OWNER laptop LOCATION '/var/lib/postgresql/tablespace/laptop';
